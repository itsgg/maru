...
Pre-1.0. Phases 0–3 are merged on `main`; Phase 4 (Distribution) is in flight. The full design is in [GENESIS.md](https://github.com/itsgg/maru/blob/main/GENESIS.md), which is the normative source of truth.
